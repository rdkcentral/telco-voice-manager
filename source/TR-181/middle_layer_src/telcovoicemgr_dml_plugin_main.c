...
int ANSC_EXPORT_API TELCOVOICEMGR_Init(ULONG uMaxVersionSupported, void* hCosaPlugInfo)
{
 ...
 pPlugInfo->RegisterFunction(pPlugInfo->hContext, "TelcoVoiceMgrDml_CallControl_OutgoingMapList_AddEntry",TelcoVoiceMgrDml_CallControl_OutgoingMapList_AddEntry);
 pPlugInfo->RegisterFunction(pPlugInfo->hContext,  "TelcoVoiceMgrDml_CallControl_OutgoingMapList_DelEntry",TelcoVoiceMgrDml_CallControl_OutgoingMapList_DelEntry);
 ...
 pPlugInfo->RegisterFunction(pPlugInfo->hContext, "TelcoVoiceMgrDml_CallControl_NumberingPlanList_AddEntry",TelcoVoiceMgrDml_CallControl_NumberingPlanList_AddEntry);
 pPlugInfo->RegisterFunction(pPlugInfo->hContext, "TelcoVoiceMgrDml_CallControl_NumberingPlanList_DelEntry",TelcoVoiceMgrDml_CallControl_NumberingPlanList_DelEntry);
 ...
 pPlugInfo->RegisterFunction(pPlugInfo->hContext, "TelcoVoiceMgrDml_CallLogList_SessionList_Stats_GetParamUlongValue",TelcoVoiceMgrDml_CallLogList_SessionList_Stats_GetParamUlongValue);
