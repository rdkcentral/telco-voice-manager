...
#define DML_VOICESERVICE_CALLLOG_SESSION_SOURCE_VOICEQUALITY          DML_VOICESERVICE_PARAM_NAME"CallLog.%d.Session.%d.Source.VoiceQuality."
#define DML_VOICESERVICE_CALLLOG_SESSION_STATS_PARAM_NAME             DML_VOICESERVICE_PARAM_NAME"CallLog.%d.Session.%d.X_RDKCENTRAL-COM_Stats."
